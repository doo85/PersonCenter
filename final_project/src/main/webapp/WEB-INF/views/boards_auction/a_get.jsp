...
function Applicant() {
	confirm("경매신청을 하시겠습니까? ")
	{
		$.ajax({
					url : "applicantRequest",
					method : "post",
					data : {
...
//카운터
   ...
   countDownTimer('sample02', '01/02/2023 11:04 PM'); // 2024년 4월 1일까지, 시간을 표시하려면 01:00 AM과 같은 형식을 사용한다.
   countDownTimer('sample03', '04/01/2024'); // 2024년 4월 1일까지
   countDownTimer('sample04', '04/01/2023'); // 2024년 4월 1일까지
			...
			<div class="ArticleTopBtns">
				<div class="right_area">
					...
					<a href="${pageContext.request.contextPath}/boards_auction"
						role="button" class="BaseButton BaseButton--skinGray size_default">
				...
				<div class="article_header">
					...
					<div class="ArticleTool">
						<a href="#" role="button" class="button_comment"><svg
							...
							<strong class="num">${auction.board_replies }</strong></a><a href="#"
							...
							<c:if test="${!empty auction.board_fileid }">
								<div class="product_section">
									...
									<div class="product_area">
										...
										<input type="button"
											onClick="Applicant('${auction.board_num}')" value="경매 신청"
											class="btn btn-default">
										...
										<div class="product_detail">
											<div class="product_detail_box">
												<div class="ProductCategory">카테고리 /
													${auction.board_category }</div>
												<p class="ProductName">
													<em class="SaleLabel sold"> [판매] </em>
													${auction.board_title }
												</p>
														...
														<c:if test="${loginid ne auction.board_id }">
															...
															<c:if
																...
																<form action="friendRequest" method="post"
																	...
																	<!-- 게시글작성자아이디  -->
																	<input type="hidden" id="friend_id" name="friend_id"
																		value="${auction.board_id }"> <input
																		type="hidden" id="board_num" name="board_num"
																		value="${auction.board_num }">
																	<button type="submit"
																	...
																	<c:forEach var="items" items="${request}">
																		<tr>
																			...
																			<td><input type="hidden" id="board_num"
																				name="board_num" value="${auction.board_num }">
																				<input type="button"
